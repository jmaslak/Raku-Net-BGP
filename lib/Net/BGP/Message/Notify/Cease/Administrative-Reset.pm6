...
use StrictClass;
unit class Net::BGP::Message::Notify::Cease::Administrative-Reset:ver<0.5.1>:auth<cpan:JMASLAK>
...
# Administrative-Reset Types
method implemented-error-subcode(-->Int) { 4 }
method implemented-error-subname(-->Str) { 'Administrative-Reset' }
...
method Str(-->Str:D) {
    my $out = "NOTIFY CEASE Administrative-Reset";
    if self.reason ne '' {
...
# Register handler
INIT { Net::BGP::Message::Notify::Cease.register(Net::BGP::Message::Notify::Cease::Administrative-Reset) }

=begin pod

=head1 NAME

Net::BGP::Message::Notify::Cease::Administative-Reset - Administrative-Reset Cease Error BGP Notify Message

=head1 SYNOPSIS

  # We create Administrative-Reset messages using the parent class.
...
Administrative-Reset Cease error BGP Notify message type
